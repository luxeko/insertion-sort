...
function generateBars(n = -1) {
	...
	for (let i = 0; i < n; i++) {
		bars.push(`<div class="bar" id="${i}">${Math.floor(2 + Math.random() * 98)}</div>`);
	}
